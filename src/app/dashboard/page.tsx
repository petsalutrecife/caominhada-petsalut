    ...
    try {
      ...
      if (navigator.canShare && navigator.canShare({ files: [file] })) {
        await navigator.share({
          files: [file],
          title: `Cãominhada Pet Salute 2026 - ${registration.petName}`,
          text: `Eu e ${registration.petName} vamos para a Cãominhada Pet Salute 2026! 🐾 Venha você também: https://caominhada.petsalut.com.br`,
        });
      } else {
