...
export default function InstitutionLoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!email.trim() || !password.trim()) {
      setError('Preencha o e-mail e a senha da instituição parceira.');
      return;
    }
        ...
        <div className="max-w-md w-full bg-white dark:bg-slate-950 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden p-8 flex flex-col animate-in zoom-in-95 duration-200">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
              Acesse sua conta para visualizar e validar as doações recebidas pela sua ONG.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                ...
                <input
                  id="email"
                  type="email"
                  placeholder="suaong@petsalute.com"
                  value={email}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="mt-2 py-3 rounded-2xl font-bold bg-[#003A8C] hover:bg-blue-800 text-white dark:bg-lime-500 dark:hover:bg-lime-600 dark:text-slate-950 transition-colors flex items-center justify-center gap-2 hover-lift disabled:opacity-50 text-sm shadow-md"
            >
