...
export default function AdminDashboard() {
  ...
  const handleExportCSV = (exportAll: boolean | React.MouseEvent = false) => {
    ...
    link.href = url;
    link.setAttribute('download', `Participantes_Caominhada_Pet_Salute_${Date.now()}.csv`);
  ...
  const handleExportPDF = () => {
    ...
    doc.setFontSize(10);
    doc.text(`Cãominhada Pet Salute 2026 • Gerado em: ${new Date().toLocaleDateString('pt-BR')}`, 15, 26);
                  ...
                  <form onSubmit={handleSaveAdminSecurity} className="flex flex-col gap-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="flex flex-col gap-1.5 text-left">
                        ...
                        <input
                          type="text"
                          placeholder="Ex: Administrador Pet Salute"
                          value={adminName}
